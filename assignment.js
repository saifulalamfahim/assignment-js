...
var fatherGaveMeKilometer = kilometerToMeter(7);
console.log(fatherGaveMeKilometer);

//end kilometerToMeter function..


//start budgetCalculater function..

function budgetCalculater(watch, mobile, laptop){
...
var gadgetQuantity = budgetCalculater(8, 7, 9);
console.log(gadgetQuantity);

//end budgetCalculater function..
...
var friendName = megaFriend(["hamara","ninja","haturi", "jiyan", "doremon", "per", "man", "shishimanu", "dora"]);
